function onLogin(player)
	...
	local regainStaminaMinutes = offlineTime / GameConfig.StaminaRegen.free
	if regainStaminaMinutes > maxNormalStaminaRegen then
		local happyHourStaminaRegen = (offlineTime - (maxNormalStaminaRegen * 180)) / GameConfig.StaminaRegen.premium
